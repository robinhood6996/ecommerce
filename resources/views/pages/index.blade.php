...
@php
	...
	$hotDeal       = DB::table('products')->join('brands','products.brand_id','brands.id')->select('products.*','brands.brand_name')->where('status',1)->where('hot_deal',1)->orderBY('id','desc')->limit(4)->get();
@endphp
								...
								<div class="owl-item deals_item">
									...
									<div class="deals_content">
										...
										<div class="deals_info_line d-flex flex-row justify-content-start">
											...
											@if($ht->discount_price == NULL)
											<div class="deals_item_price ml-auto"><strike>${{ $ht->selling_price }}</strike></div>
											@else 
											@endif
											@if($ht->discount_price != NULL)
								...
								<div class="featured_slider slider">
									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset( $product->image_one) }}" height="120px" width="140px" alt=""></div>
											<div class="product_content">
												
												@if ($product->discount_price == NULL)
												<span class="text-danger"><b> ${{ $product->selling_price}}</b></span>
											    @else 
...
@php
	$mid = DB::table('products')->join('categories','products.category_id','categories.id')->join('brands','products.brand_id','brands.id')->select('products.*','categories.category_name','brands.brand_name')->where('products.mid_slider',1)->where('products.status',1)->limit(5)->orderBY('id','desc')->get();
...
@endphp
							...
							<div class="row fill_height">
								<div class="col-lg-4 col-md-6 fill_height">
									<div class="banner_2_content">
										<div class="banner_2_category">{{ $row->brand_name }}</div>
										<div class="banner_2_title">{{ $row->product_name }}</div>
										<div class="banner_2_text">{{ $row->category_name }}</div>
								...
								<div class="col-lg-8 col-md-6 fill_height">
									<div class="banner_2_image_container">
										<div class="banner_2_image"><img src="{{ asset( $row->image_one )}}" style="width:400px; height:450px" alt="">
										</div>
									</div>
								</div>
							</div>
	...
	<div class="new_arrivals">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="tabbed_container">
						<div class="tabs clearfix tabs-right">
							...
							<ul class="clearfix">
								<li class="active">Trending Products</li>
				...
				@php
					$trend = DB::table('products')->where('trend',1)->where('status',1)->orderBY('id','desc')->limit(12)->get();
				@endphp						
										<!-- Slider Item -->
	...
	<!-- Trends -->
@php
	$bogo = DB::table('products')->where('bogo',1)->where('status',1)->orderBY('id','desc')->limit(12)->get();
@endphp
	<div class="trends">
			...
			<div class="row">
				...
				<div class="col-lg-3">
					<div class="trends_container">
						<h2 class="trends_title">BOGO OFFER</h2>
				...
				<div class="col-lg-9">
					<div class="trends_slider_container">
						...
						<div class="owl-carousel owl-theme trends_slider">
							...
							<!-- Trends Slider Item -->
							@foreach ($bogo as $product)
								
						
							<div class="owl-item">
								<div class="trends_item is_new">
									<div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{asset($product->image_one)}}" alt=""></div>
									<div class="trends_content">
										...
										<div class="trends_info clearfix">
											...
											@else 
											<div class="trends_price" style="color: red;">${{ $product->discount_price }}<span style="font-size: 11px; color:rgb(139, 139, 139); padding-left:5px">${{ $product->selling_price }}</span></div>
											@endif
										</div>
									</div>
									<ul class="trends_marks">
										@if ($product->discount_price == NULL)
										<li class="trends_mark trends_new" style="background: green;">NEW</li>
										@else
										@php
										$ammount = $product->selling_price - $product->discount_price;
										$discount = $ammount/$product->discount_price*100;
									...
									<button style="color: white" class="addwishlist" data-id="{{ $product->id }}">
